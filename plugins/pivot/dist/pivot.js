  ...
  callWithJQuery(function($) {
    ...
    aggregators = (function(tpl) {
      return {
        ...
        "Suma": tpl.sum(usFmt),
        "Entero Sum": tpl.sum(usFmtInt),
        "Promedio": tpl.average(usFmt),
        "Media": tpl.median(usFmt),
        "Varianza de la muestra": tpl["var"](1, usFmt),
        "Desviacińo estandar de lam uestra": tpl.stdev(1, usFmt),
        "Mínimo": tpl.min(usFmt),
        "Máxio": tpl.max(usFmt),
        "Primero": tpl.first(usFmt),
        "Último": tpl.last(usFmt),
        "Suma sobre suma": tpl.sumOverSum(usFmt),
        "80% Límite superior": tpl.sumOverSumBound80(true, usFmt),
        "80% Límite inferior": tpl.sumOverSumBound80(false, usFmt),
    ...
    renderers = {
      ...
      "Tabla y Gráfico de barras": function(data, opts) {
        return $(pivotTableRenderer(data, opts)).barchart();
      },
      "Mapa de calor": function(data, opts) {
        return $(pivotTableRenderer(data, opts)).heatmap("heatmap", opts);
      },
      "Mapa de calor de fila": function(data, opts) {
        return $(pivotTableRenderer(data, opts)).heatmap("rowheatmap", opts);
      },
      "Mapa de calor de columna": function(data, opts) {
    ...
    locales = {
      en: {
        ...
        renderers: renderers,
        localeStrings: {
          renderError: "Un error ocurrió generando los resultados.",
          computeError: "Un error ocurrió al realizar el proceso de los resultados.",
          uiRenderError: "Un error ocurrió al generar la interfaz.",
          selectAll: "Seleccionar todos",
          selectNone: "Seleccionar ninguno",
          tooMany: "(muchos para listar)",
          filterResults: "Valores filtrados",
          apply: "Aplicar",
          cancel: "Cancelar",
          totals: "Totales",
          vs: "vs",
