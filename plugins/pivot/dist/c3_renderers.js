(function() {
  ...
  callWithJQuery(function($, c3) {
    ...
    return $.pivotUtilities.c3_renderers = {
      "Gráfico de barras horizontal": makeC3Chart({
        type: "bar",
        horizontal: true
      }),
      "Gráfico de barras horizontal apilado": makeC3Chart({
        type: "bar",
        stacked: true,
        horizontal: true
      }),
      "Gráfico de barras": makeC3Chart({
        type: "bar"
      }),
      "Gráfico de barras apilado": makeC3Chart({
        type: "bar",
        stacked: true
      }),
      "Gráfico de línea": makeC3Chart(),
      "Gráfico de área": makeC3Chart({
        type: "area",
        stacked: true
      }),
      "Gráfico de disperción": makeC3Chart({
        type: "scatter"
      })
    };
  });
