...
class Proveedor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre_proveedor', 'required'),
			array('nombre_proveedor', 'length', 'max'=>60),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_proveedor, nombre_proveedor', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'productos' => array(self::HAS_MANY, 'Producto', 'id_proveedor'),
		);
	}
