...
class TipoUsuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tipo_usuario', 'required'),
			array('tipo_usuario', 'length', 'max'=>25),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_tipousuario, tipo_usuario', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'procedimientoPrestadors' => array(self::HAS_MANY, 'ProcedimientoPrestador', 'id_tipousuario'),
		);
	}
