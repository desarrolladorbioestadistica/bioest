...
class Modalidad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre_modalidad', 'required'),
			array('nombre_modalidad', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_modalidad, nombre_modalidad', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'capacidadInstaladas' => array(self::HAS_MANY, 'CapacidadInstalada', 'id_modalidad'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nombre_modalidad',$this->nombre_modalidad,true);
