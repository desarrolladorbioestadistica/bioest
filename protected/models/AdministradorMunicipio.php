...
/**
 * This is the model class for table "administrador_municipio".
 *
 * The followings are the available columns in table 'administrador_municipio':
 ...
 */
class AdministradorMunicipio extends CActiveRecord
{
	/**
	...
	{
		return 'administrador_municipio';
	}
	...
	public function rules()
	{
		...
		return array(
			array('id_admin, id_municipio', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_administradormunicipio, id_admin, id_municipio', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'afilicions' => array(self::HAS_MANY, 'Afilicion', 'id_administradormunicipio'),
	 ...
	 * @return AdministradorMunicipio the static model class
	 */
