<?php
    ...
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/plugins/pivot/dist/pivot.es.js",CClientScript::POS_END);
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/plugins/pivot/dist/c3_renderers.js",CClientScript::POS_END);
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/plugins/pivot/dist/gchart_renderers.js",CClientScript::POS_END);
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/js/pages/Reportes/ReportesCapInstalada.js",CClientScript::POS_END);
?>
<!-- Select Plugin Js -->
    <script src="../../plugins/bootstrap-select/js/bootstrap-select.js"></script>
<div id="divReportCapInstalada">
    <div class="block-header">
        <h2>REPORTES DE CAPACIDAD INSTALADA DE PRESTADORES</h2>
    </div>
