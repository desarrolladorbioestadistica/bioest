<?php
    ...
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/js/pages/Reportes/ReportesServicios.js",CClientScript::POS_END);
?>
<!-- Select Plugin Js -->
    <script src="../../plugins/bootstrap-select/js/bootstrap-select.js"></script>
<div id="divReportServ">
    <div class="block-header">
        <h2>REPORTES DE SERVICIOS DE PRESTADORES</h2>
    </div>
