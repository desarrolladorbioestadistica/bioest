<?php
    ...
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/js/pages/Reportes/ReportesAdmon.js",CClientScript::POS_END);
?>
<!-- Select Plugin Js -->
    <script src="../../plugins/bootstrap-select/js/bootstrap-select.js"></script>
<div id="divReport">
    <div class="block-header">
        <h2>REPORTES ADMINISTRADORAS</h2>
    </div>
            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="formReport">
                        <div class="row clearfix">
                            <div class="col-sm-3">
                                <?php echo CHtml::dropDownList('Report[anio]', "", 
                                    CHtml::listData($anio,'anio_afiliacion', 'anio_afiliacion'),
                                    array('empty' => '(Seleccione un año)'));
                                ?>
                            </div>
                            <div class="col-sm-3">
                                <?php echo CHtml::dropDownList('Report[mes]', "", 
                                    CHtml::listData($mes,'mes_afiliacion', 'nombre_mes'),
                                    array('multiple'=>'multiple', 'title'=>"Seleccione un mes"));
                                ?>
                            </div>
                        </div>
