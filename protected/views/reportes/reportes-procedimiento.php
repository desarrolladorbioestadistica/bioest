<?php
    ...
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/js/pages/Reportes/ReportesProc.js",CClientScript::POS_END);
?>
<!-- Select Plugin Js -->
    <script src="../../plugins/bootstrap-select/js/bootstrap-select.js"></script>
<div id="divReportProc">
    <div class="block-header">
        <h2>REPORTES DE PROCEDIMIENTOS</h2>
    </div>
